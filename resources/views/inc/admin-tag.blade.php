<div class="px-6 text-right flex justify-between mb-4 ">
    <h1 class=" font-semibold text-3xl">Tags</h1>
    <a href="{{ route('create-tag') }}" class="text-base border text-indigo-600 border-indigo-600 px-6 py-2 hover:opacity-75">Create
        New Tag</a>
</div>
